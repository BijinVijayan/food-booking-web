export default function CardSkeleton() {
    return (
        <div className="flex gap-4 p-3 bg-white dark:bg-zinc-900 rounded-xl border border-zinc-100 dark:border-zinc-800 animate-pulse">
            {/* Image Placeholder */}
            <div className="w-28 h-28 shrink-0 rounded-sm bg-zinc-200 dark:bg-zinc-800" />
