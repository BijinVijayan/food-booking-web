    ...
    return (
        <div className="space-y-6 md:space-y-8">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
                <div>
                    <h1 className="text-2xl md:text-3xl font-bold text-zinc-900">Welcome Back, Admin</h1>
                ...
                <div className="flex gap-3 w-full md:w-auto">
                    ...
                    <button className="flex-1 md:flex-none bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 md:py-2 rounded-xl font-bold shadow-lg shadow-orange-500/20 text-sm">
                        + New Order
                    </button>
                </div>
            </div>
